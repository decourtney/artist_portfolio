...
const SliderControl = ({ arrowDirection, onClick }: SliderControlProps) => {
  return (
    <div
      id="slider-control"
      className={`absolute flex top-0 ${arrowDirection}-0 w-[3.9vw] h-full bg-black bg-opacity-25 text-5xl text-white z-10 pointer-events-auto cursor-pointer hover:bg-opacity-50`}
      onClick={onClick}
    >
